...
import com.illinois.safetyratingsuiuc.databinding.ActivityResourceBinding;
...
public class Resource extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(binding.appBarResource.toolbar);
        binding.appBarResource.fab.setOnClickListener(new View.OnClickListener() {
            @Override
